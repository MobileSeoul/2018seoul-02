...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    public SystemWebViewEngine(SystemWebView webView, CordovaPreferences preferences) {
        ...
        webView.addJavascriptInterface(new AndroidBridge(), "seoulApp");
    ...
    public class AndroidBridge{
        ...
        @JavascriptInterface
        public void getGPS() { // must be final
            handler.post(new Runnable() {
                public void run() {
                    ((CordovaActivity) CordovaActivity.mContext).getGPS();
                    webView.loadUrl("javascript:console.log('getGPS!!!')");
                }
            });
        }
        @JavascriptInterface
        public void getGPSPermission() { // must be final
            handler.post(new Runnable() {
                public void run() {
                    ((CordovaActivity) CordovaActivity.mContext).getGPSPermission();
                    webView.loadUrl("javascript:console.log('getGPSPermission!!!')");
                }
            });
        }
        @JavascriptInterface
        public void SignUpgetGPS() { // must be final
            handler.post(new Runnable() {
                public void run() {
                    ((CordovaActivity) CordovaActivity.mContext).SignUpgetGPS();
                    webView.loadUrl("javascript:console.log('!!!')");
                }
            });
        }
